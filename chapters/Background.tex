...
$$\psi : \mathcal{R}^{\mathcal{S} X \mathcal{A}}\rightarrow \mathcal{R}$$ for the cost function. Moreover, instead of maximizing the expected reward they find a cost function, under which 
