...
The reinforcement learning optimality condition \ref{rl_objective} for both state-value and action-state value functions can be used to derive the optimal policy.
