...
A downside of \ac{her} is that it requires the inverse function $g(s)$, meaning from a visited state, the goal must be reconstructible. This is not always given.
