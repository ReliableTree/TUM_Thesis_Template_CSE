...
The active critic architecture consists of an actor and a critic, similar to actor critic methods. The main difference is, that AVC uses the whole sequence of 
...
\begin{figure}
    ...
    \end{tikzpicture}
\caption{Overview of the inference mechanism of Active Critic. The solid lines indicate the forward path, the dashed lines indicate backward gradients, which 
...
This problem did not occur with the AVC algorithm, as the action sequence is only optimised 
