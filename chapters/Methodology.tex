...
Another way to motivate the imitation learning paradigm for our actor comes from using the lower bound on plicy improvement from the TRPO paper \cite{TRPO}.
