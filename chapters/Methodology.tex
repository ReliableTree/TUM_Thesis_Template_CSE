...
accordingly. This feature is key for efficient planning. We motivate our architectural choices in detail and develop the search algorithm in the following sections.
...
We can now see the distribution shift error \ref{eq:def_di_sh_err} is zero, as there is no dependency of $C$ on $\pi$. 
