...
Formally we define a continuous fixed horizon single observation POMDP as a tuple \\
...
An approaches to laverage expert demonstrations by sampling them with higher priority \cite{vecerik2018leveraging} has limited convergence rate towards expert behaviour and is dependent on additional hyper parameters. 
